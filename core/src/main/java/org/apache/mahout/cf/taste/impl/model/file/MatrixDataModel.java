...
private float nullPreferenceValue;
  ...
  void setPreferenceValue(int userID, int itemID, float preferenceValue, FastByIDMap<?> data) {
  ...
  /**
   * Note that this method only updates the in-memory preference data that this {@link MatrixDataModel}

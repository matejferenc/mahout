...
public final class SamplingLIntPrimitiveIterator extends AbstractIntPrimitiveIterator {
	...
	private final IntPrimitiveIterator delegate;
	private Integer next;
	private boolean hasNext;

	public SamplingLIntPrimitiveIterator(IntPrimitiveIterator delegate, double samplingRate) {
		this(RandomUtils.getRandom(), delegate, samplingRate);
	}

	public SamplingLIntPrimitiveIterator(RandomWrapper random, IntPrimitiveIterator delegate, double samplingRate) {
	...
	public static IntPrimitiveIterator maybeWrapIterator(IntPrimitiveIterator delegate, double samplingRate) {
		return samplingRate >= 1.0 ? delegate : new SamplingLIntPrimitiveIterator(delegate, samplingRate);
	}

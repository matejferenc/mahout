...
public class RatingSGDFactorizer extends AbstractFactorizer {
	...
	protected void updateParameters(long userID, long itemID, float rating, double currentLearningRate) {
		...
		// adjust user bias
		userVector[USER_BIAS_INDEX] += biasLearningRate * currentLearningRate * (err - biasReg * preventOverfitting * userVector[USER_BIAS_INDEX]);
	...
	public String getShortName() {
		return "SGD" + numIterations + "I" + numFeatures + "F";
	}
}

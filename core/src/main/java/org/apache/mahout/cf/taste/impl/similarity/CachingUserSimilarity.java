...
public final class CachingUserSimilarity implements UserSimilarity {
	...
	/**
	 * Creates this on top of the given {@link UserSimilarity}. The cache is sized according to properties of the given {@link DataModel}.
	 */
	...
	/**
	 * Creates this on top of the given {@link UserSimilarity}. The cache size is capped by the given size.
	 */

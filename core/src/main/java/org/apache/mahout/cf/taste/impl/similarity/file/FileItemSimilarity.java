...
/**
 * <p>
 * An {@link ItemSimilarity} backed by a comma-delimited file. This class typically expects a file where each line contains an item ID, followed by another item ID, followed by a similarity value, separated by commas.
 * You may also use tabs.
 * </p>
 *
 * <p>
 * The similarity value is assumed to be parseable as a {@code double} having a value between -1 and 1. The item IDs are parsed as {@code long}s. Similarities are symmetric so for a pair of items you do not have to

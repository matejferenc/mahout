...
public final class FastByIDMap<V> implements Serializable, Cloneable {
	 ...
	 *             if size is less than 0, maxSize is less than 1 or at least half of {@link RandomUtils#MAX_INT_SMALLER_TWIN_PRIME}, or loadFactor is less than 1
	 */
	...
	public IntPrimitiveIterator keySetIterator() {
	...
	private final class KeyIterator extends AbstractIntPrimitiveIterator {
	...
	private final class EntrySet extends AbstractSet<Map.Entry<Integer, V>> {
		...
		@Override
		public boolean add(Map.Entry<Integer, V> t) {
		...
		@Override
		public boolean addAll(Collection<? extends Map.Entry<Integer, V>> ts) {
			throw new UnsupportedOperationException();
		}

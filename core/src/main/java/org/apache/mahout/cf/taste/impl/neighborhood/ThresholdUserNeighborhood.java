...
public final class ThresholdUserNeighborhood extends AbstractUserNeighborhood {
	 ...
	 *             if threshold is {@link Double#NaN}, or if samplingRate is not positive and less than or equal to 1.0, or if userSimilarity or dataModel are {@code null}
	 */
	 ...
	 * @throws IllegalArgumentException
	 *             if threshold or samplingRate is {@link Double#NaN}, or if samplingRate is not positive and less than or equal to 1.0, or if userSimilarity or dataModel are {@code null}
	 */
	...
	public long[] getUserNeighborhood(long userID) throws TasteException {
		...
		IntPrimitiveIterator usersIterable = SamplingLIntPrimitiveIterator.maybeWrapIterator(dataModel.getUserIDs(), getSamplingRate());

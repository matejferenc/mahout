...
public interface UserBasedRecommender extends Recommender {
	 ...
	 */
	Integer[] mostSimilarUserIDs(Integer userID, int howMany) throws TasteException;
	 ...
	 *            desired number of most similar users to find
	 * @param rescorer
	 *            {@link Rescorer} which can adjust user-user similarity estimates used to determine most similar users
	 * @return IDs of users most similar to the given user
	 * @throws TasteException
	 *             if an error occurs while accessing the {@link org.apache.mahout.cf.taste.model.DataModel}
	 */
	Integer[] mostSimilarUserIDs(Integer userID, int howMany, Rescorer<IntPair> rescorer) throws TasteException;

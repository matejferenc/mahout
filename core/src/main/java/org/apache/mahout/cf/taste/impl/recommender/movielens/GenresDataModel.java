package org.apache.mahout.cf.taste.impl.recommender.movielens;
...
public class GenresDataModel {
	...
	protected void processLine(String line, FastByIDMap<Set<String>> data, FastByIDMap<String> names) {
		...
		List<String> genres = readGenresFromString(genresString);
		Set<String> genresSet = new HashSet<String>(genres);

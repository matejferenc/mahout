...
public final class GenericRelevantItemsDataSplitter implements RelevantItemsDataSplitter {
	...
	@Override
	public FastIDSet getRelevantItemsIDs(Integer userID, int at, double relevanceThreshold, DataModel dataModel) throws TasteException {
	...
	@Override
	public void processOtherUser(Integer userID, FastIDSet relevantItemIDs, FastByIDMap<PreferenceArray> trainingUsers, Integer otherUserID, DataModel dataModel) throws TasteException {

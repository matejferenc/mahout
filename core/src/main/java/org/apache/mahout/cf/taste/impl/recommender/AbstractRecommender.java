...
public abstract class AbstractRecommender implements Recommender {
	...
	/**
	 * <p>
	 * Default implementation which just calls {@link Recommender#recommend(long, int, org.apache.mahout.cf.taste.recommender.IDRescorer)}, with a {@link org.apache.mahout.cf.taste.recommender.Rescorer} that does
	 * nothing.
	 * </p>
	 */
	@Override
	 ...
	 * @return all items in the {@link DataModel} for which the user has not expressed a preference and could possibly be recommended to the user
